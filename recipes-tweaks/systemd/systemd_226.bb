...
PACKAGECONFIG[gnuefi] = "--enable-gnuefi --with-efi-includedir=${STAGING_INCDIR} --with-efi-ldsdir=${STAGING_LIBDIR} --with-efi-libdir=${STAGING_LIBDIR},--disable-qnuefi,gnu-efi"
